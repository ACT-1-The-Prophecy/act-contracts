    ...
    PausableUpgradeable
{
    ...
    function registerAgent(
        ...
        ACT_STORY.registerAgent(sender);
    ...
    function submitTask(uint96 _taskId, string calldata _result) external {
        ...
        ACT_STORY.submitTask(_taskId, task.assignedAgent);
